<template>
    <div class="container mx-auto">
        <Header/>
        <button class="flex items-center justify-center block w-full py-4 mt-12 bg-white md:hidden" @click="toggleFilters">
        ...
        <div class="relative flex justify-center mt-12">
            <div
                class="absolute z-50 flex flex-col items-center justify-center w-full -mt-10 text-center transition duration-500 ease-in-out bg-white md:mr-8 md:sticky md:opacity-100 md:pointer-events-auto md:mt-0 md:bg-transparent md:w-auto md:block "
